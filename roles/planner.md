...
- Writes acceptance as Given/When/Then and Verify as commands built from the repo's own commands in `.compasso/project.yaml`, with the test frameworks `testing` names there.
